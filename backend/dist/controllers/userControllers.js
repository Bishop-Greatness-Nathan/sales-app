...
const currentUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const user = yield userModel_1.default.findOne({ _id: (_a = req.user) === null || _a === void 0 ? void 0 : _a.userId }).select("-password");
    if (!user)
...
const updateUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (String((_a = req.user) === null || _a === void 0 ? void 0 : _a.userId) !== String(user._id) &&
...
const changePassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield userModel_1.default.findOne({ _id: (_a = req.user) === null || _a === void 0 ? void 0 : _a.userId });
    if (!user)
